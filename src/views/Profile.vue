  ...
  <div class="user-overview">
    <div class="card card-side shadow-lg bg-base-200">
      ...
      <div class="card-body mt-auto mb-auto">
        <h2 class="card-title text-2xl cursor-default select-none">
          {{ username }}

          <div v-if="skyhousePlus" class="
        ...
        <div class="card-actions flex-grow-0 profCardActions">
          ...
          <button v-if="skyhousePlus" @click="logout" class="btn btn-primary">
            Sign Out
          </button>
          <button v-if="!skyhousePlus" @click="logout" class="btn btn-ghost">
            Sign Out
          </button>
        </div>
      </div>
