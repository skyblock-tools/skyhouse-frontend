  ...
  <div class="box profBox xl:pl-80 xl:pr-80 xl:pt-8 transition-all">
    <div class="card shadow-xl image-full">
      ...
      <div class="justify-end card-body">
        ...
        <p>Skyhouse+ is our way of having a premium on our services. The profits from this go solely towards maintaining the service and future projects. By subscribing to Skyhouse+ you are directly supporting us and you also receive benefits</p>
    <div class="p-3">
      ...
      <p>- Future perks</p>
        ...
        <div class="card-actions">
          <a v-if="skyhousePlus" class="btn btn-info btn-disabled">You already have Skyhouse+</a>

          <label for="skyHouseBuy" class="transition btn btn-info" v-if="!skyhousePlus" >Purchase Skyhouse+</label>
          <input type="checkbox" id="skyHouseBuy" class="modal-toggle">
          <div class="modal">
            <div class="modal-box">

              <h1 class="card-title text-2xl "> Choose your payment gateway.</h1>
              <p>You will be redirected to the gateway to complete your purchase.</p>
<div class="flex flex-row">
    <a href="#" class="card shadow-xl image-full pt-6">
      <figure>
          <img src="../assets/stripe.jpg" class="rounded-2xl">
    </figure>
    <div class=" btn-block btn-ghost rounded-2xl card-body transition">
    <h2 class="card-title">Card/Paypal (Recommended)</h2>
  </div>
</a>
<label for="Patreond" href="#" class="card shadow-xl image-full pt-6 mx-3">
  <figure>
...
<div class="modal pt-44">
  <div class="modal-box bg-base-200">
    <p>Patreon is a deprecated payment gateway. Support will be dropped in a future version. Please only continue if you know what you're doing!</p>
    <div class="modal-action">
      <a  href="https://www.patreon.com/skyblock_tools" class="btn btn-ghost hover:text-error">Procceed</a>
      <label for="Patreond" class="btn btn-outline btn-secondary">Back</label>
    </div>
  </div>
</div>
  </div>
