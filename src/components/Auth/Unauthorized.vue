...
<label for="skyHouseLogin" class="btn btn-accent" v-if="mode == 1" @click="loginButton">Login via discord</label>
...
<div class="lds-ripple"><div></div><div></div></div>
    <p>Securely logging you in via Discord...</p>
        ...
        <a class="btn btn-ghost" v-if="mode == 2" @click="joinDiscord">{{ txt }}</a>
